...
| Question | Proceed | Pause or kill |
|---|---|---|
| Is there demand? | Many apps, active reviews, people already tracking | Few active apps, low review volume |
| Is there dissatisfaction? | Repeated complaints across multiple apps | Users mostly satisfied |
| Is the gap specific? | "Users want one-tap logging without gamification" | "People want better UX" |
| Can a solo builder address it? | Gap is product/UX-focused | Requires clinical credibility or integrations |
| Is the MVP small? | Buildable in weeks | Needs many features before it's useful |
| Would someone switch? | Pain is frequent and annoying | Existing apps are good enough |
...
<details>
<summary>Pitfall: finding a gap but ignoring the kill criteria</summary>
